...
CREATE TABLE `HORARIO` ( `id` INT(20) PRIMARY KEY AUTO_INCREMENT,`id_materia` INT(10) NOT NULL , `dia_semana` int(1) NOT NULL , `horario` VARCHAR(11) NOT NULL , `semestre` INT(6) NOT NULL, FOREIGN KEY (id_materia) REFERENCES MATERIA(id));
